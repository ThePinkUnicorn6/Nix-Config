...
Credits go to these projects which I have made use of extensively as reference or included in these dots.
...
+ https://github.com/soulhotel/FF-ULTIMA :: Is used to theme Firefox, making it beautiful.
